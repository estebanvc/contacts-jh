...
import com.develrox.api.contacts.service.ContactService;
...
/**
 * REST controller for managing {@link com.develrox.api.contacts.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
public class ContactResource {
    ...
    private static final String ENTITY_NAME = "contactsContact";
